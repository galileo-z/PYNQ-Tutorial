...
HD_PWD='D:/Vivado/PYNQ-Tutorial/PYNQ-Tutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_half.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Add_half.tcl
