...
HD_PWD='D:/Vivado/PYNQ-Tutorial/PYNQ-Tutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_half.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Add_half.tcl -notrace
